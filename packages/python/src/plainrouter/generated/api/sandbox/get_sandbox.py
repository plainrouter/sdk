...
from ...models.get_sandbox_response_200 import GetSandboxResponse200
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> GetSandboxResponse200 | None:
    if response.status_code == 200:
        response_200 = GetSandboxResponse200.from_dict(response.json())
