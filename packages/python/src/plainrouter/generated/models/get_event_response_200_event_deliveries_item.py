...
if TYPE_CHECKING:
    from ..models.get_event_response_200_event_deliveries_item_last_error_type_0 import (
        GetEventResponse200EventDeliveriesItemLastErrorType0,
    )
    from ..models.get_event_response_200_event_deliveries_item_platform_response_type_0 import (
        GetEventResponse200EventDeliveriesItemPlatformResponseType0,
    )


T = TypeVar("T", bound="GetEventResponse200EventDeliveriesItem")


@_attrs_define
class GetEventResponse200EventDeliveriesItem:
    """
    Attributes:
        id (int):
        ...
        is_test (bool):
        attempt_count (int):
        last_error (GetEventResponse200EventDeliveriesItemLastErrorType0 | list[Any] | None):
        platform_response (GetEventResponse200EventDeliveriesItemPlatformResponseType0 | list[Any] | None):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_error, GetEventResponse200EventDeliveriesItemLastErrorType0):
        ...
        if isinstance(self.platform_response, GetEventResponse200EventDeliveriesItemPlatformResponseType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_last_error(data: object) -> GetEventResponse200EventDeliveriesItemLastErrorType0 | list[Any] | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_error_type_0 = GetEventResponse200EventDeliveriesItemLastErrorType0.from_dict(data)
            ...
            try:
                ...
                pass
            return cast(GetEventResponse200EventDeliveriesItemLastErrorType0 | list[Any] | None, data)

        last_error = _parse_last_error(d.pop("last_error"))

        def _parse_platform_response(
            data: object,
        ) -> GetEventResponse200EventDeliveriesItemPlatformResponseType0 | list[Any] | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                platform_response_type_0 = GetEventResponse200EventDeliveriesItemPlatformResponseType0.from_dict(data)
            ...
            try:
                ...
                pass
            return cast(GetEventResponse200EventDeliveriesItemPlatformResponseType0 | list[Any] | None, data)
        ...
        get_event_response_200_event_deliveries_item.additional_properties = d
        return get_event_response_200_event_deliveries_item
