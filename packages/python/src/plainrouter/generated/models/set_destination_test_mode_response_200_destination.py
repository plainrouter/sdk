...
if TYPE_CHECKING:
    from ..models.set_destination_test_mode_response_200_destination_config_type_0 import (
        SetDestinationTestModeResponse200DestinationConfigType0,
    )


T = TypeVar("T", bound="SetDestinationTestModeResponse200Destination")


@_attrs_define
class SetDestinationTestModeResponse200Destination:
    """
    Attributes:
        id (str):
        ...
        config (list[Any] | None | SetDestinationTestModeResponse200DestinationConfigType0):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.config, SetDestinationTestModeResponse200DestinationConfigType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_config(data: object) -> list[Any] | None | SetDestinationTestModeResponse200DestinationConfigType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                config_type_0 = SetDestinationTestModeResponse200DestinationConfigType0.from_dict(data)
            ...
            try:
                ...
                pass
            return cast(list[Any] | None | SetDestinationTestModeResponse200DestinationConfigType0, data)
        ...
        set_destination_test_mode_response_200_destination.additional_properties = d
        return set_destination_test_mode_response_200_destination
