...
T = TypeVar("T", bound="SendTestPurchaseBody")


@_attrs_define
class SendTestPurchaseBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        send_test_purchase_body = cls(
            value=value,
            currency=currency,
            order_id=order_id,
        )

        send_test_purchase_body.additional_properties = d
        return send_test_purchase_body
