...
if TYPE_CHECKING:
    from ..models.list_events_by_cursor_response_200_events_data_item_click_ids_type_0 import (
        ListEventsByCursorResponse200EventsDataItemClickIdsType0,
    )
    from ..models.list_events_by_cursor_response_200_events_data_item_consent_type_0 import (
        ListEventsByCursorResponse200EventsDataItemConsentType0,
    )
    from ..models.list_events_by_cursor_response_200_events_data_item_deliveries_item import (
        ListEventsByCursorResponse200EventsDataItemDeliveriesItem,
    )
    from ..models.list_events_by_cursor_response_200_events_data_item_session_type_0 import (
        ListEventsByCursorResponse200EventsDataItemSessionType0,
    )
    from ..models.list_events_by_cursor_response_200_events_data_item_user_data_hashed_type_0 import (
        ListEventsByCursorResponse200EventsDataItemUserDataHashedType0,
    )
    from ..models.list_events_by_cursor_response_200_events_data_item_value_data_type_0 import (
        ListEventsByCursorResponse200EventsDataItemValueDataType0,
    )


T = TypeVar("T", bound="ListEventsByCursorResponse200EventsDataItem")


@_attrs_define
class ListEventsByCursorResponse200EventsDataItem:
    """
    Attributes:
        id (str):
        ...
        deliveries (list[ListEventsByCursorResponse200EventsDataItemDeliveriesItem]):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.consent, ListEventsByCursorResponse200EventsDataItemConsentType0):
        ...
        if isinstance(self.user_data_hashed, ListEventsByCursorResponse200EventsDataItemUserDataHashedType0):
        ...
        if isinstance(self.click_ids, ListEventsByCursorResponse200EventsDataItemClickIdsType0):
        ...
        if isinstance(self.session, ListEventsByCursorResponse200EventsDataItemSessionType0):
        ...
        if isinstance(self.value_data, ListEventsByCursorResponse200EventsDataItemValueDataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_consent(data: object) -> list[Any] | ListEventsByCursorResponse200EventsDataItemConsentType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                consent_type_0 = ListEventsByCursorResponse200EventsDataItemConsentType0.from_dict(data)
            ...
            try:
                ...
                pass
            return cast(list[Any] | ListEventsByCursorResponse200EventsDataItemConsentType0 | None, data)

        consent = _parse_consent(d.pop("consent"))

        def _parse_user_data_hashed(
            data: object,
        ) -> list[Any] | ListEventsByCursorResponse200EventsDataItemUserDataHashedType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                user_data_hashed_type_0 = ListEventsByCursorResponse200EventsDataItemUserDataHashedType0.from_dict(data)
            ...
            try:
                ...
                pass
            return cast(list[Any] | ListEventsByCursorResponse200EventsDataItemUserDataHashedType0 | None, data)

        user_data_hashed = _parse_user_data_hashed(d.pop("user_data_hashed"))

        def _parse_click_ids(
            data: object,
        ) -> list[Any] | ListEventsByCursorResponse200EventsDataItemClickIdsType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                click_ids_type_0 = ListEventsByCursorResponse200EventsDataItemClickIdsType0.from_dict(data)
            ...
            try:
                ...
                pass
            return cast(list[Any] | ListEventsByCursorResponse200EventsDataItemClickIdsType0 | None, data)

        click_ids = _parse_click_ids(d.pop("click_ids"))

        def _parse_session(data: object) -> list[Any] | ListEventsByCursorResponse200EventsDataItemSessionType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                session_type_0 = ListEventsByCursorResponse200EventsDataItemSessionType0.from_dict(data)
            ...
            try:
                ...
                pass
            return cast(list[Any] | ListEventsByCursorResponse200EventsDataItemSessionType0 | None, data)

        session = _parse_session(d.pop("session"))

        def _parse_value_data(
            data: object,
        ) -> list[Any] | ListEventsByCursorResponse200EventsDataItemValueDataType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_data_type_0 = ListEventsByCursorResponse200EventsDataItemValueDataType0.from_dict(data)
            ...
            try:
                ...
                pass
            return cast(list[Any] | ListEventsByCursorResponse200EventsDataItemValueDataType0 | None, data)
        ...
        for deliveries_item_data in _deliveries:
            deliveries_item = ListEventsByCursorResponse200EventsDataItemDeliveriesItem.from_dict(deliveries_item_data)
        ...
        list_events_by_cursor_response_200_events_data_item.additional_properties = d
        return list_events_by_cursor_response_200_events_data_item
