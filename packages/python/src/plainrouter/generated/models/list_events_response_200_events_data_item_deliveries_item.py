...
if TYPE_CHECKING:
    from ..models.list_events_response_200_events_data_item_deliveries_item_last_error_type_0 import (
        ListEventsResponse200EventsDataItemDeliveriesItemLastErrorType0,
    )
    from ..models.list_events_response_200_events_data_item_deliveries_item_platform_response_type_0 import (
        ListEventsResponse200EventsDataItemDeliveriesItemPlatformResponseType0,
    )


T = TypeVar("T", bound="ListEventsResponse200EventsDataItemDeliveriesItem")


@_attrs_define
class ListEventsResponse200EventsDataItemDeliveriesItem:
    """
    Attributes:
        id (int):
        ...
        is_test (bool):
        attempt_count (int):
        last_error (list[Any] | ListEventsResponse200EventsDataItemDeliveriesItemLastErrorType0 | None):
        platform_response (list[Any] | ListEventsResponse200EventsDataItemDeliveriesItemPlatformResponseType0 | None):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_error, ListEventsResponse200EventsDataItemDeliveriesItemLastErrorType0):
        ...
        if isinstance(self.platform_response, ListEventsResponse200EventsDataItemDeliveriesItemPlatformResponseType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_last_error(
            data: object,
        ) -> list[Any] | ListEventsResponse200EventsDataItemDeliveriesItemLastErrorType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_error_type_0 = ListEventsResponse200EventsDataItemDeliveriesItemLastErrorType0.from_dict(data)
            ...
            try:
                ...
                pass
            return cast(list[Any] | ListEventsResponse200EventsDataItemDeliveriesItemLastErrorType0 | None, data)

        last_error = _parse_last_error(d.pop("last_error"))

        def _parse_platform_response(
            data: object,
        ) -> list[Any] | ListEventsResponse200EventsDataItemDeliveriesItemPlatformResponseType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                ...
                platform_response_type_0 = (
                    ListEventsResponse200EventsDataItemDeliveriesItemPlatformResponseType0.from_dict(data)
                )
            ...
            try:
                ...
                pass
            return cast(list[Any] | ListEventsResponse200EventsDataItemDeliveriesItemPlatformResponseType0 | None, data)
        ...
        list_events_response_200_events_data_item_deliveries_item = cls(
            id=id,
            signal_tracker_id=signal_tracker_id,
            event_id=event_id,
            destination_id=destination_id,
        ...
        list_events_response_200_events_data_item_deliveries_item.additional_properties = d
        return list_events_response_200_events_data_item_deliveries_item
