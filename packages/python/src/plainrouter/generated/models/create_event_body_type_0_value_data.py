...
T = TypeVar("T", bound="CreateEventBodyType0ValueData")


@_attrs_define
class CreateEventBodyType0ValueData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_event_body_type_0_value_data = cls(
            value=value,
            currency=currency,
            order_id=order_id,
            contents=contents,
        ...
        create_event_body_type_0_value_data.additional_properties = d
        return create_event_body_type_0_value_data
