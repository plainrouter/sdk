...
if TYPE_CHECKING:
    from ..models.validate_sandbox_event_with_key_body_value_data import ValidateSandboxEventWithKeyBodyValueData


T = TypeVar("T", bound="ValidateSandboxEventWithKeyBody")


@_attrs_define
class ValidateSandboxEventWithKeyBody:
    """
    Attributes:
        ...
        value_data (ValidateSandboxEventWithKeyBodyValueData | Unset): Optional synthetic commerce data.
    """

    event_name: str
    event_id: str | Unset = UNSET
    action_source: str | Unset = UNSET
    value_data: ValidateSandboxEventWithKeyBodyValueData | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        value_data: ValidateSandboxEventWithKeyBodyValueData | Unset
        if isinstance(_value_data, Unset):
            value_data = UNSET
        else:
            value_data = ValidateSandboxEventWithKeyBodyValueData.from_dict(_value_data)

        validate_sandbox_event_with_key_body = cls(
            event_name=event_name,
            event_id=event_id,
        ...
        validate_sandbox_event_with_key_body.additional_properties = d
        return validate_sandbox_event_with_key_body
