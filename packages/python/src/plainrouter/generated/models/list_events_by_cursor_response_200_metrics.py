...
T = TypeVar("T", bound="ListEventsByCursorResponse200Metrics")


@_attrs_define
class ListEventsByCursorResponse200Metrics:
    """
    Attributes:
        accepted (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_events_by_cursor_response_200_metrics = cls(
            accepted=accepted,
            total_deliveries=total_deliveries,
            acceptance_rate=acceptance_rate,
            acceptance_rate_window=acceptance_rate_window,
        ...
        list_events_by_cursor_response_200_metrics.additional_properties = d
        return list_events_by_cursor_response_200_metrics
