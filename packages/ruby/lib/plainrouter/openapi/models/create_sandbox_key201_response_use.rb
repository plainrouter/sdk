  ...
  class CreateSandboxKey201ResponseUse < ApiModelBase
    ...
    def list_invalid_properties
      ...
      if @authorization.nil?
        invalid_properties.push('invalid value for "authorization", authorization cannot be nil.')
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] authorization Value to be assigned
    def authorization=(authorization)
      if authorization.nil?
        fail ArgumentError, 'authorization cannot be nil'
      end
